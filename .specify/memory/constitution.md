...
- **Type Hinting:** ALWAYS include type hints for all parameters and return types. Verify with **MyPy** (strict mode).
...
- **Testing Framework:** Use `pytest` for all unit, integration, and contract tests.
